	      ...
	      {tag: "div", attrs: {}, children: [
	        {tag: "div", attrs: {class:"header bf"}, children: [
	          {tag: "div", attrs: {class:"center"}, children: [
	            {tag: "a", attrs: {class:"headLogo", href:"index.html"}, children: ["万屏汇"]}, 
	            {tag: "div", attrs: {class:"nav"}, children: [
	              {tag: "a", attrs: {class:"@@index", href:"index.html"}, children: ["快速报装"]}, 
	              {tag: "a", attrs: {class:"", href:"examples.html"}, children: ["24H托管"]}, 
	              {tag: "a", attrs: {class:"", href:"service.html"}, children: ["自助报修"]}, 
	              {tag: "a", attrs: {class:"", href:"#"}, children: ["选用指南"]}
	            ]}, 
	            ...
	            {tag: "div", attrs: {class:"user"}, children: [
	              {tag: "div", attrs: {class:"user_nav guest"}, children: [
	                {tag: "p", attrs: {}, children: ["你还没登录/注册"]}, 
	                {tag: "div", attrs: {}, children: [
	                {tag: "a", attrs: {class:"ms", href:"#"}, children: ["我的屏幕"]}, 
	                {tag: "a", attrs: {class:"mf", href:"#"}, children: ["个人资料"]}, 
	                {tag: "a", attrs: {class:"ll", href:"#"}, children: ["登录/注册"]}
	                ]}
	              ]}, 
	              {tag: "div", attrs: {class:"user_nav c client"}, children: [
	                {tag: "div", attrs: {}, children: [
	                {tag: "a", attrs: {class:"ms", href:"my_screens.html"}, children: ["我的屏幕"]}, 
	                {tag: "a", attrs: {class:"mf", href:"my_screens.html?pop=profile"}, children: ["个人资料"]}, 
	                {tag: "a", attrs: {class:"lo", href:"#"}, children: ["注销"]}
	                ]}
	              ]}, 
	              {tag: "div", attrs: {class:"user_nav s manaScreen"}, children: [
	                {tag: "div", attrs: {}, children: [
	                {tag: "a", attrs: {class:"ms", href:"bs_my_screens.html"}, children: ["我管理的屏幕"]}, 
	                {tag: "a", attrs: {class:"mw", href:"bs_my_screens.html?pop=bs_wallet"}, children: ["我的钱包"]}, 
	                {tag: "a", attrs: {class:"mf", href:"bs_my_screens.html?pop=bs_profile"}, children: ["个人资料"]}, 
	                {tag: "a", attrs: {class:"lo", href:"#"}, children: ["注销"]}
	                ]}
	              ]}
	            ]}
	        ...
	        {tag: "div", attrs: {class:"user_form login c hide"}, children: [
	          ...
	          {tag: "h2", attrs: {}, children: ["登录/注册"]}, 
	          {tag: "form", attrs: {method:"post"}, children: [
	            {tag: "input", attrs: {class:"input phone", type:"text", placeholder:"手机号", value:""}}, 
	              {tag: "input", attrs: {class:"input l code", type:"text", placeholder:"验证码"}}, 
	              {tag: "input", attrs: {class:"btn l getcode", type:"button", value:"获取验证码"}}, 
	            {tag: "input", attrs: {type:"button", class:"btn submit", value:"提交"}}
	          ]}, 
	          {tag: "div", attrs: {class:"loginError"}, children: ["验证码出错，重新登录"]}, 
	          {tag: "a", attrs: {class:"to_supplier", href:"#"}, children: ["我是供应商"]}
	        ]}, 
	        ...
	        {tag: "div", attrs: {class:"user_form login s hide"}, children: [
	          ...
	          {tag: "div", attrs: {class:"close"}}, 
	          {tag: "form", attrs: {method:"post"}, children: [
	            {tag: "h2", attrs: {}, children: ["供应商登录/注册"]}, 
	            {tag: "input", attrs: {class:"input phone", type:"text", placeholder:"手机号"}}, 
	            {tag: "div", attrs: {}, children: [
	              {tag: "input", attrs: {class:"input l code", type:"text", placeholder:"验证码"}}, 
	              {tag: "input", attrs: {class:"btn l getcode", type:"button", value:"获取验证码"}}
	            ]}, 
	      ...
	      {tag: "div", attrs: {class:"pk bf"}, children: [
	        {tag: "div", attrs: {class:"center"}, children: [
	          {tag: "div", attrs: {class:"c1 wow fadeInRight animated", "data-wow-delay":"0.1s", "data-wow-duration":".3s", style:"visibility: visible; animation-duration: 0.3s; animation-delay: 0.1s;"}, children: [
	            ...
	            {tag: "p", attrs: {}, children: ["货源"]}, 
	            {tag: "p", attrs: {}, children: ["商家"]}, 
	            {tag: "p", attrs: {}, children: ["方案"]}, 
	            {tag: "p", attrs: {}, children: ["报价"]}, 
	            {tag: "p", attrs: {}, children: ["安装"]}, 
	            {tag: "p", attrs: {}, children: ["检测"]}, 
	            {tag: "p", attrs: {}, children: ["维修"]}, 
	            {tag: "p", attrs: {}, children: ["咨询"]}, 
	          ...
	          {tag: "div", attrs: {class:"c3 wow fadeInRight animated", "data-wow-delay":"0.3s", "data-wow-duration":".3s", style:"visibility: visible; animation-duration: 0.3s; animation-delay: 0.3s;"}, children: [
	            {tag: "h2", attrs: {}, children: ["传统供应商"]}, 
	            {tag: "p", attrs: {}, children: ["从二道贩子手上进货"]}, 
	            {tag: "p", attrs: {}, children: ["碰到谁是谁"]}, 
	            {tag: "p", attrs: {}, children: ["跑断腿找多家"]}, 
	            {tag: "p", attrs: {}, children: ["好货不便宜，便宜无好货"]}, 
	            {tag: "p", attrs: {}, children: ["上门安装，给师傅包烟"]}, 
	            {tag: "p", attrs: {}, children: ["自己盯着"]}, 
	            {tag: "p", attrs: {}, children: ["供应商售后（如果能找到）"]}, 
	            {tag: "p", attrs: {}, children: ["看供应商时间"]}
	          ]}, 
	          {tag: "div", attrs: {class:"c3 cfinal wow fadeInRight animated", "data-wow-delay":"0.4s", "data-wow-duration":".3s", style:"visibility: visible; animation-duration: 0.3s; animation-delay: 0.4s;"}, children: [
	            {tag: "h2", attrs: {}, children: ["X宝／X里巴巴"]}, 
	            {tag: "p", attrs: {}, children: ["厂商或者二道贩子搞不清楚"]}, 
	            {tag: "p", attrs: {}, children: ["碰到谁是谁"]}, 
	            {tag: "p", attrs: {}, children: ["自己判断，自己做方案"]}, 
	            {tag: "p", attrs: {}, children: ["好货不便宜，便宜无好货"]}, 
	            {tag: "p", attrs: {}, children: ["自己安装"]}, 
	            {tag: "p", attrs: {}, children: ["祈祷千万别坏"]}, 
	            {tag: "p", attrs: {}, children: ["没有售后一说"]}, 
	            {tag: "p", attrs: {}, children: ["卖出不管"]}
	          ]}, 
	  ...
	  view: function(scope) {
	    return (
	      {tag: "div", attrs: {class:"banner"}, children: [
	        {tag: "div", attrs: {class:"center"}, children: [
	          {tag: "h3", attrs: {}, children: ["千家品牌厂商直供，多家报价可比，平台统一承保"]}, 
	          {tag: "h1", attrs: {}, children: ["上门安装LED屏"]}, 
	          {tag: "div", attrs: {id:"tips_signup", class:"btn pop"}, children: ["10秒登记，三家上门提供方案"
	          ]}, 
	          {tag: "form", attrs: {class:"mt20 bookin", action:"javascript:;", method:"post", id:"to_signup"}, children: [
	            {tag: "div", attrs: {class:"signinName hide"}, children: [
	              {tag: "span", attrs: {}, children: ["请输入您的称呼"
	              ]}
	            ]}, 
	            {tag: "div", attrs: {class:"signinPhone hide"}, children: [
	              {tag: "span", attrs: {}, children: ["请输入正确的手机号"
	              ]}
	            ]}, 
	            {tag: "input", attrs: {class:"nick input l", placeholder:"您的称呼", value:""}}, 
	            {tag: "input", attrs: {class:"phone input l", placeholder:"手机号", value:""}}, 
	            {tag: "div", attrs: {class:"changeCity"}, children: [
	              {tag: "span", attrs: {class:"city_name"}}, 
	              {tag: "i", attrs: {class:"city_id hide"}, children: ["18"]}, 
	              {tag: "div", attrs: {class:"clicktochange"}, children: ["修改"]}
	            ]}, 
	            {tag: "input", attrs: {class:"btn l", type:"submit", value:"提交"}}
	          ]}
	        ]}
	      ]}
	    )
	  ...
	  view: function (scope) {
	    ...
	    return (
	      {tag: "div", attrs: {class:"process bl"}, children: [
	        {tag: "div", attrs: {class:"center"}, children: [
	          {tag: "h3", attrs: {class:"cb fm fadeInUp2 animated"}, children: ["服务流程", {tag: "span", attrs: {class:"cl"}, children: ["客户权益第一，我们以保障客户权益为天职"]}]}, 
	          list.map(function(item) {return (
